<?php
namespace ImageHoverEffect\PageSettings;
...
class Page_Settings {
	...
	public function add_panel_tab() {
		Controls_Manager::add_tab( self::PANEL_TAB, __( 'New Tab', 'image-hover-effect' ) );
	}
	...
	public function register_document_controls( $document ) {
		...
		$document->start_controls_section(
			'new_section',
			[
				'label' => __( 'Settings', 'image-hover-effect' ),
				'tab' => self::PANEL_TAB,
			]
		);
		...
		$document->add_control(
			...
			[
				...
				'default' => __( 'Title', 'image-hover-effect' ),
			]
		);
